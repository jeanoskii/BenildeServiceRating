    ...
    <body>
		...
		<!-- One -->
			<section id="Rate" class="main style3 primary dark fullscreen">
				<div class="content container 75%">
                        <h1 style="color:black">RATE SERVICE PROVIDER</h1>
                        <asp:ToolkitScriptManager ID="toolkitID" runat="server"></asp:ToolkitScriptManager>
                            ...
                            <ContentTemplate>
                                ...
                                <br />
                                <center>
                                    <text style="color:black">Service Provider </text><asp:LinkButton ID="btnSuggestSPLink" style="color:black" onClick="btnSuggestSPLink_Click"  runat="server" Text="(suggest?)"></asp:LinkButton>
                                    <br />
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body" id="Div2">
                  <asp:TextBox ID="txtSuggestServiceProvider" pattern="^[a-zA-Z0-9,.!? ]*$" MaxLength="50" style="color:black" class="form-control" placeholder="Please type in the name of the service provider" runat="server"></asp:TextBox>
                  <br>
                  </br>
              ...
              <div class="modal-footer">
                  ...
                  <asp:Button ID="btnSuggest" onClick="btnSuggest_Click" runat="server" class="btn btn-success" Text="SUGGEST" 
                        ></asp:Button>
                  <asp:Button ID="btnSuggestCancel" onClick="btnSuggestCancel_Click" class="btn btn-success" runat="server" Text="Cancel" />          
              </div>
            </div>
          </div>
          </asp:Panel>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body" id="Div4">
                  <h3 style="color:black">You are <asp:Label ID="lblConfirmRating" runat="server" Font-Bold></asp:Label> with <asp:Label ID="lblConfirmServiceProvider" Font-Bold runat="server"></asp:Label>
                  <br />
                  <asp:Label ID="lblConfirmComment" runat="server" Text=""></asp:Label></h3>
                  <br />
                  <asp:PlaceHolder ID="phComment" runat="server"></asp:PlaceHolder>
                  <br />
                  <h3 style="color:black">Proceed?</h3>
                  
                  
              </div>
              <div class="modal-footer">
			  
                  <asp:Button ID="btnRatingYes" onClientClick="resetImage()" onClick="btnRatingYes_Click" class="btn btn-success" runat="server" Text="Yes"/>  
                  <asp:Button ID="btnRatingNo" onClick="btnRatingNo_Click" class="btn btn-success" runat="server" Text="No"/>      
              </div>
            </div>
          </div>
        </asp:Panel>
         ...
         <asp:Panel ID="modalShow" runat="server" CssClass="modalPopup" align="center" Style="display:none">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title" style="color:black">Feel free to give comments and suggestions</h4>
              </div>
              <div class="modal-body" id="modalBody">
              <asp:Label ID="lblCommentError" class="lblClassDesign" runat="server" Text=""></asp:Label>
                  <asp:TextBox ID="commentsSuggestions" runat="server" onpaste="return false" TextMode="MultiLine" placeholder="Optional" style="resize:none; color:black" MaxLength="300"></asp:TextBox>
              </div>
              <div class="modal-footer">
			  <asp:Label ID="lblCount" runat="server" style="float:left; font-weight:bold; color:black" Text="Only 300 characters allowed"></asp:Label>
                  <asp:Button ID="btnRatingSubmit" class="btn btn-success" runat="server" Text="Submit" 
                       onclick="btnRatingSubmit_Click" />
                  <asp:Button ID="btnRatingNoThanks" OnClick="btnRatingNoThanks_Click" class="btn btn-success" runat="server" Text="No, thanks" />
             ...
             <div class="container 75%">
						    <div class="row 0% images">
                                ...
                                <asp:Button ID="btnRatingModal" runat="server"
                                    class="btn btn-success" Text="SUBMIT" style="color:white;" onClick="btnRatingModal_Click">                                         
                                </asp:Button>
