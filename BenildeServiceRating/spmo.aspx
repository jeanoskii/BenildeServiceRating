		    ...
		    <!-- One -->
			    <section id="commentsSPMO" class="main style3 primary dark fullscreen">
				    <div class="content container 75%">
                        <asp:UpdatePanel ID="upnlSearch" runat="server">
                            <ContentTemplate>
                                <h1 style="color:#555;">MANAGE COMMENTS</h1>
                                ...
                                <div id="dropDowns" style="margin-top:2%;">
                                    ...
                                    <div id="gridview2" style="margin-top:5%; overflow-y:auto; height:300px;">
                                        <asp:GridView ID="gvComments" class="table table-responsive table-hover table-bordered" style="color:#555; background-color:White; border:1px solid #555;" runat="server">
                                            <Columns>
                                    ...
                                    <br />
                                     <asp:Button ID="btnPopUpModalComment" runat="server" class="btn btn-success" style="min-width:150px"
		        ...
		        <section id="manageServiceProvider" class="main style3 dark fullscreen">
			        <div class="content container 75%">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
			                    <center>
				                    <h1 style="color:white;">MANAGE SERVICE PROVIDERS</h1>
                                    <asp:Label ID="lblServiceProviderMessage" class="lblClassDesign" runat="server" Text=""></asp:Label>
				                    <div id="div3" style="margin-top:2%">
                                
                                    <asp:TextBox ID="txtServiceProvider" class="form-control" placeholder="Please input a service provider" runat="server" style="width:50%; display:inline; background-color:White; color:#555;"></asp:TextBox>

                                     <asp:Button ID="btnAddServiceProvider" OnClick="btnAddServiceProvider_Click" class="btn btn-success" runat="server" Text="ADD"></asp:Button>

				                    </div>
                                    <br />
                                    <div id="div4" style="overflow-y:auto; height:300px">
                                        <asp:GridView ID="gvServiceProviders" class="table table-bordered table-hover table-responsive" runat="server" style="color:#555; text-align:center; background-color:White; border:1px solid #555;">
                                            <Columns>
                                                <asp:templatefield HeaderText="Select">
                                                    <itemtemplate>
				                    ...
				                    <div id="div5" style="margin-top:3%;">
                                        ...
                                        <asp:Button ID="btnPopUpModalServiceProvider" OnClick="btnPopUpModalServiceProvider_Click" style="min-width:150px" class="btn btn-success" runat="server" Text="DELETE SELECTED"></asp:Button>
                    ...
                    <a href="#manageLocation" class="button style2 down anchored">Next</a>
			    </section>
                ...
                <section id="manageLocation" class="main style3 dark fullscreen">
			        <div class="content container 75%">
                        <asp:UpdatePanel ID="upnlLocation" runat="server">
                            <ContentTemplate>
			                    <center>
				                    <h1 style="color:#555;">MANAGE LOCATIONS</h1>
				                    <div id="div1Location">
                                        <b><asp:Label ID="lblLocationMessage" class="lblClassDesign" runat="server" Text=""></asp:Label></b><br />
                                        <asp:TextBox style="display:inline; width:50%; background-color:White; color:#555;" class="form-control" ID="txtLocation" placeholder="Please input a location" runat="server"></asp:TextBox>
                                        <asp:Button ID="btnAddLocation" class="btn btn-success" 
                                            runat="server" Text="ADD" onclick="btnAddLocation_Click"></asp:Button>
					                    <br/>
                                        <br />
				                    </div>
                                    <div id="div2Location" style="overflow-y:auto; height:300px">
                                        <asp:GridView ID="gvLocations" class="table table-bordered table-hover table-responsive" runat="server" style="color:#555; text-align:center; background-color:White; border:1px solid #555;">
                                            <Columns>
                                                <asp:templatefield HeaderText="Select">
                                                    <itemtemplate>
				                    ...
				                    <div id="div3Location" style="margin-top:3%;">
                                        ...
                                        <asp:Button ID="btnPopUpModalLocation" style="min-width:150px" class="btn btn-success" onClick="btnPopUpModalLocation_Click" runat="server" Text="DELETE SELECTED"></asp:Button>
			    ...
			    <section id="manageServiceProviderLocation" class="main style3 right dark fullscreen">
                            ...
                            <ContentTemplate>   
				                ...
				                <div id="topForm">
                                    ...
                                    <asp:Button ID="btnServiceProviderLocationAdd" OnClick="btnServiceProviderLocationAdd_Click" runat="server" class="btn btn-success" 
                                             style="display:inline" Text="ADD" />
                                             </center>
				                </div>
				                <br>
                                <br>
                                <div id="gridView" style="overflow-y:auto; height:300px;">
                                    <asp:GridView ID="gvServiceProvidersLocations" class="table table-bordered table-hover" runat="server" style="color:#555; background-color:White; border:1px solid #555;">
                                        <Columns>
                                            <asp:templatefield HeaderText="Select">
                                                <itemtemplate>
                                ...
                                <br />
                                <asp:Button ID="btnPopUpModalServiceProviderLocation" style="min-width:150px" runat="server" 
                    ...
                    <asp:ModalPopupExtender ID="mpeServiceProviderLocationDeleteSuccess" runat="server" PopupControlID="deleteSPSuccessfulModalShow" TargetControlID="btnTestingSuccessfulDeleteSP" CancelControlID="btnDeleteSPSuccessfulModal">        			
                     ...
                     <a href="#pendingServiceProvider" class="button style2 down anchored">Next</a> 
                </section>
                ...
                <section id="pendingServiceProvider" class="main style3 dark fullscreen">
			        <div class="content container 75%">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
					                <h1 style="color:#555">MANAGE PENDING SERVICE PROVIDER</h1>
                                    <asp:Label ID="lblPending" class="lblClassDesign" runat="server"></asp:Label>
					                <div id="Div7" style="overflow-y:auto; height:300px">
						                <asp:GridView ID="gvSuggestions" class="table table-bordered table-hover" runat="server" style="color:#555; background-color:White">
                                            <Columns>
                                                <asp:templatefield HeaderText="Select">
                                                    <itemtemplate>
                                    ...
                                    <br />
                                    <asp:Button ID="btnApprovedSelected" OnClick="btnApprovedSelected_Click" style="min-width:120px" runat="server" class="btn btn-success"  
                                            Text="APPROVE"></asp:Button>
                                    <asp:Button ID="btnDisapprovedSelected" OnClick="btnDisapprovedSelected_Click" style="min-width:120px" runat="server" class="btn btn-success"  
                ...
                <section id="changeRateLimit" class="main style3 dark fullscreen">
			        <div class="content container 75%">
                        <asp:UpdatePanel ID="upnlRateLimit" runat="server">
                            <ContentTemplate>
                            <center> 
				                        <h1 style="color:white;">CHANGE RATE LIMIT</h1> 
                                        <b><asp:Label ID="lblRateLimitError" class="lblClassDesign" runat="server" Text=""></asp:Label></b>
                                        <br />
                                        <asp:TextBox style="background-color:White; color:#555;max-width:160px;height:100px" class="form-control" 
                                            placeholder="Hour" ID="txtAddRateLimit" runat="server" 
                                            type="number" min="0" max="48" onpaste="return false" Font-Size="42pt"></asp:TextBox>
                                        <br />
                                        <asp:Button ID="btnAddRateLimit" class="btn btn-success" 
                                            runat="server" Text="ADD" onclick="btnAddRateLimit_Click"></asp:Button>
                                        <br />
                                        <br />
                                        <br />  
                                        <asp:DropDownList ID="ddlSelectRateLimit"  style="max-width:160px;height:100px"
                                            runat="server" class="form-control" Font-Size="42pt"></asp:DropDownList>
                                         <br />
                                        <asp:Button class="btn btn-success" ID="btnSelectRateLimit" 
                                            runat="server" Text="SAVE SELECTED" onclick="btnSelectRateLimit_Click"></asp:Button>
			                 </center>
                ...
                <section id="changeQuestion" class="main style3 dark fullscreen">
			        <div class="content container 75%">
                        <asp:UpdatePanel ID="upnlQuestion" runat="server">
                            <ContentTemplate>
                                <h1 style="color:#555;">CHANGE QUESTION</h1>
                                <asp:Label ID="lblQuestionMessage" class="lblClassDesign" runat="server" Text=""></asp:Label>
                                <br />
                                <asp:TextBox ID="txtQuestionAdd" runat="server" placeholder="Please input a question" style="background-color:white; color:#555;max-width:390px" class="form-control"></asp:TextBox>
                     ...
                     <div class="container 75%">
						    <div class="row 0% images">
								<div class="6u">
                                    <center>
                                        <img id="happy" class="image fit from-left" src="css/images/smileys/hoc.png"/>
                                        <asp:TextBox ID="txtAnswerPositive" class="form-control" placeholder=" Positive Answer" runat="server" style="width:150px; margin-top:3%; background-color:white; color:#555;"></asp:TextBox>
                                    </center>
                                </div>
								<div class="6u">
                                    <center>
                                        <img id="sad" class="image fit from-left" src="css/images/smileys/soc.png"/>        
                                        <asp:TextBox ID="txtAnswerNegative" class="form-control" placeholder=" Negative Answer" runat="server" style="width:150px; margin-top:3%; background-color:white; color:#555;"></asp:TextBox>
                                    </center>
                                </div>
                            </div>

                            <asp:Button ID="btnAddAnswers" runat="server" class="btn btn-success" 
                                Text="ADD ANSWER" onclick="btnAddAnswers_Click"></asp:Button>
                            <br />

                    </div>
                    <br />

                    <asp:DropDownList ID="ddlQuestion" runat="server" class="form-control" style="max-width:360px; margin-top:5%;"></asp:DropDownList>
                    <asp:Button ID="btnQuestionSet" runat="server" class="btn btn-success" Text="SET QUESTION" onclick="btnQuestionSet_Click"></asp:Button>
                    <br />
                    <asp:DropDownList ID="ddlAnswer" runat="server" class="form-control" style="max-width:360px; margin-top:5%;"></asp:DropDownList>
                    <asp:Button ID="btnSetAnswer" runat="server" class="btn btn-success" Text="SET ANSWER" onclick="btnSetAnswer_Click"></asp:Button>
                     ...
                     <asp:Button ID="btnTestingAddAnswer" runat="server" Text="" style="display:none"></asp:Button>
                     <asp:Button ID="btnTestingSA" runat="server" Text="" style="display:none"></asp:Button>
                    ...
                    <asp:ModalPopupExtender ID="mpeAddAnswer" runat="server" PopupControlID="addAnswerModalShow" TargetControlID="btnTestingAddAnswer" CancelControlID="btnAddAnswerModal">        			
                    </asp:ModalPopupExtender>


                    <asp:ModalPopupExtender ID="mpeSetAnswer" runat="server" PopupControlID="setAnswerModalShow" TargetControlID="btnTestingSA" CancelControlID="btnCancelAnswerModal">        			
                    </asp:ModalPopupExtender>
                             ...
                             <Triggers>
                                ...
                                <asp:AsyncPostBackTrigger ControlID="btnSetAnswerModal" EventName="Click" />
                                <asp:AsyncPostBackTrigger ControlID="btnCancelAnswerModal" EventName="Click" />
                                <%--<asp:AsyncPostBackTrigger ControlID="btnYesAnswer" EventName="Click" />--%>
                            </Triggers>
                ...
                <section id="changeAdmin" class="main style3 dark fullscreen">
			        <div class="content container 75%">
                        <asp:UpdatePanel ID="upnlAdmin" runat="server">
                            <ContentTemplate>
			                    <center>
				                    <h1 style="color:white;">CHANGE ADMIN</h1>
				                    <div id="div1">
				                    ...
				                    <div id="div2" style="margin-top:3%;">
                                        <p>New Admin: </p>
                                        <asp:TextBox style="display:inline; width:50%; background-color:white; color:#555;" class="form-control" placeholder="Please input the username" ID="txtNewAdmin" runat="server"></asp:TextBox>
                 ...
                 <div id="footerDiv">
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">Are you sure you want to remove this/these service provider(s) and location(s)?</h4>
                          </div>
                          <div class="modal-footer">
			  
                               <asp:Button ID="btnDeleteServiceProviderLocation" onclick="btnDeleteServiceProviderLocation_Click" class="btn btn-default" runat="server" Text="YES"/>
                              <asp:Button ID="btnCancelDeleteServiceProviderLocation" onclick="btnCancelDeleteServiceProviderLocation_Click" class="btn btn-danger" runat="server" Text="NO" />
                    ...
                    <asp:Panel ID="disapproveSPModalShow" runat="server" CssClass="modalPopup" align="center" style="display:none">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">You have successfully disapproved a service provider.</h4>
                          </div>
                          <div class="modal-footer">
                    ...
                    <asp:Panel ID="deleteSPOnlyModalShow" runat="server" CssClass="modalPopup" align="center" style="display:none">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">Are you sure you want to remove this/these service provider(s)?</h4>
                          </div>
                          <div class="modal-footer">
			  
                               <asp:Button ID="btnDeleteServiceProvider" onclick="btnDeleteServiceProvider_Click" class="btn btn-default" runat="server" Text="YES"/>
                              <asp:Button ID="btnCancelDeleteServiceProvider" onclick="btnCancelDeleteServiceProvider_Click" class="btn btn-danger" runat="server" Text="NO" />
                    ...
                    <asp:Panel ID="saveAdminModalShow" runat="server" CssClass="modalPopup" align="center" style="display:none">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">Are you sure you want to transfer your rights to  this user?</h4>
                          </div>
                          <div class="modal-footer">
			  
                               <asp:Button ID="btnYesAdmin" class="btn btn-default" runat="server" Text="YES" 
                                   onclick="btnYesAdmin_Click"/>
                              <asp:Button ID="btnNoAdmin" class="btn btn-danger" runat="server" Text="NO" />
                    ...
                    <asp:Panel ID="addSPandLModalShow" runat="server" CssClass="modalPopup" align="center" style="display:none">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">You have successfully added a service provider and location.</h4>
                          </div>
                          <div class="modal-footer">
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">You have successfully deleted a comment.</h4>
                          </div>
                          <div class="modal-footer">
                    ...
                    <asp:Panel ID="successfulDeleteSPOnlyModalShow" runat="server" CssClass="modalPopup" align="center" style="display:none">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">You have successfully deleted a service provider.</h4>
                          </div>
                          <div class="modal-footer">
                    ...
                    <asp:Panel ID="changeAdminModalShow" runat="server" CssClass="modalPopup" align="center" style="display:none">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">You have successfully changed the admin. You will be automatically logged out on the system.</h4>
                          </div>
                          <div class="modal-footer">
                    ...
                    <asp:Panel ID="successfulDeleteLocationModalShow" runat="server" CssClass="modalPopup" align="center" style="display:none">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">You have successfully deleted a location.</h4>
                          </div>
                          <div class="modal-footer">
                    ...
                    <asp:Panel ID="approveSPModalShow" runat="server" CssClass="modalPopup" align="center" style="display:none">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">You have successfully approved a service provider.</h4>
                          </div>
                          <div class="modal-footer">
                    ...
                    <asp:Panel ID="addServiceProviderlOnlyModalShow" runat="server" CssClass="modalPopup" align="center" style="display:none">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">You have successfully added a service provider.</h4>
                          </div>
                          <div class="modal-footer">
                    ...
                    <asp:Panel ID="deleteSPSuccessfulModalShow" runat="server" CssClass="modalPopup" align="center" style="display:none">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">You have successfully deleted a service provider-location</h4>
                          </div>
                          <div class="modal-footer">
                    ...
                    <asp:Panel ID="addLocationModalShow" runat="server" CssClass="modalPopup" align="center" style="display:none">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">You have successfully added a location.</h4>
                          </div>
                          <div class="modal-footer">
                    ...
                    <asp:Panel ID="addRLModalShow" runat="server" CssClass="modalPopup" align="center" style="display:none">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">You have successfully added a rate limit.</h4>
                          </div>
                          <div class="modal-footer">
                    ...
                    <asp:Panel ID="addAnswerModalShow" runat="server" CssClass="modalPopup" align="center" style="display:none">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">You have successfully added an answers.</h4>
                          </div>
                          <div class="modal-footer">
			  
                              <asp:Button ID="btnAddAnswerModal" class="btn btn-success" runat="server" Text="OK" />
...
<%--
                    <asp:Panel ID="setAnswerModalShow" runat="server" CssClass="modalPopup" align="center" style="display:none">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">You have successfully added an answers.</h4>
                          ...
                          <div class="modal-footer">
                              ...
                              <asp:Button ID="btnSetAnswerModal" class="btn btn-success" runat="server" Text="OK" />
...
--%>
                    ...
                    <asp:Panel ID="addQuestionModalShow" runat="server" CssClass="modalPopup" align="center" style="display:none">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">You have successfully added a question.</h4>
                          </div>
                          <div class="modal-footer">
                    ...
                    <asp:Panel ID="modalCommentShow" runat="server" CssClass="modalPopup" align="center" style="display:none">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">Are you sure you want to delete this/these comment(s)?</h4>
                          </div>
                          <div class="modal-footer">
			  
                               <asp:Button ID="btnDeleteComment" onClick="btnDeleteComment_Click" class="btn btn-default" runat="server" Text="YES"/>
                              <asp:Button ID="btnCancelDeleteComment" onClick="btnCancelDeleteComment_Click" class="btn btn-danger" runat="server" Text="NO" />
                    ...
                    <asp:Panel ID="manageRLModalShow" runat="server" CssClass="modalPopup" align="center" style="display:none">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">Are you sure you want to set this rate limit?</h4>
                          </div>
                          <div class="modal-footer">
			  
                               <asp:Button ID="btnSetRateLimitModal" onclick="btnSetRateLimitModal_Click" class="btn btn-default" runat="server" Text="YES"/>
                              <asp:Button ID="btnCancelRateLimitModal" class="btn btn-danger" runat="server" Text="NO" />
                    ...
                    <asp:Panel ID="setQuestionModalShow" runat="server" CssClass="modalPopup" align="center" style="display:none">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">Are you sure you want to set this question?</h4>
                          </div>
                          <div class="modal-footer">
			  
                               <asp:Button ID="btnSetQuestionModal" onclick="btnSetQuestionModal_Click" class="btn btn-default" runat="server" Text="YES"/>
                              <asp:Button ID="btnCancelQuestionModal" class="btn btn-danger" runat="server" Text="NO" />
                     ...
                     <asp:Panel ID="setAnswerModalShow" runat="server" CssClass="modalPopup" align="center" style="display:none">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">Are you sure you want to set this answer?</h4>
                          </div>
                          <div class="modal-footer">
			  
                               <asp:Button ID="btnSetAnswerModal" onclick="btnSetAnswerModal_Click" class="btn btn-default" runat="server" Text="YES"/>
                              <asp:Button ID="btnCancelAnswerModal" class="btn btn-danger" runat="server" Text="NO" />
                    ...
                    <asp:Panel ID="deleteLocationModalShow" runat="server" CssClass="modalPopup" align="center" style="display:none">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title" style="color:#555">Are you sure you want to remove this/these location(s)?</h4>
                          </div>
                          <div class="modal-footer">
                              <asp:Button ID="btnDeleteLocation" onclick="btnDeleteLocation_Click" 
                                  class="btn btn-default" runat="server" Text="YES"/>
                              <asp:Button ID="btnCancelDeleteLocation" OnClick="btnCancelDeleteLocation_Click" class="btn btn-danger" runat="server" Text="NO" />
