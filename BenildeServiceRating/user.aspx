          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body" id="Div4">
                  <h3 style="color:#555">
                      You answered: <asp:Label ID="lblConfirmRating" runat="server" Font-Bold></asp:Label>
                      <br />
                      With: <asp:Label ID="lblConfirmServiceProvider" Font-Bold runat="server"></asp:Label>
                      <br />
                      <asp:Label ID="lblConfirmComment" runat="server" Text=""></asp:Label>
                  </h3>
                  <br />
            ...
            <div class="modal-content">
			  ...
			  <asp:Label ID="lblCount" runat="server" style="float:left; font-weight:bold; color:#555" Text="Only 300 characters allowed"></asp:Label>
                ...
                <div>
				 ...
				 <asp:TextBox ID="Answer" runat="server" style="display:none"></asp:TextBox>
                 </div>
						    ...
						    <div class="row 0% images">
								<div class="6u">
                                    <center>
                                        ...
                                        <asp:Label ID="lblPositiveAnswer" runat="server" Text="" style="color:#555" Font-Size="X-Large"></asp:Label>
                                    </center>
                                </div>
								<div class="6u">
                                    <center>        
                                        <img id="sad" class="image fit from-right" src="css/images/smileys/snc.png" onclick="changeImage2(this);" title="SAD" alt="" />
                                        <asp:Label ID="lblNegativeAnswer" runat="server" Text="" style="color:#555" Font-Size="X-Large"></asp:Label>
                                    </center>
                                </div>
                            </div>
            </div>
