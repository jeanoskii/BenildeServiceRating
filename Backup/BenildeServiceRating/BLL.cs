...
namespace ThreeTier
{
    namespace BusinessLogic
    {
        class BLL
        {
            ...
            {
                return DAL.GetData("SELECT * FROM Admins WHERE is_active = '" + isActive + "'");
            }
            ...
            {
                return DAL.GetData("INSERT INTO Admins OUTPUT inserted.admin_id VALUES('" + username + "','" + isActive + "')");
            }
            public DataTable AdminSetActive()
            {
                return DAL.GetData("UPDATE Admins SET is_active = '" + isActive + "' OUTPUT deleted.admin_id, inserted.admin_id WHERE username = '" + username + "'");
            }
            public void AdminSetInactive()
            {
                DAL.Execute("UPDATE Admins SET is_active = '" + isActive + "' WHERE admin_id NOT IN ('" + adminID + "')");            
            }
            #endregion
            ...
            public DataTable SPMOCommentFilter1()
            {
                ...
                "and Service_Providers_Locations.location_id = Locations.location_id and Comments.is_deleted = '" + isDeleted + "' " +
            ...
            {
                return DAL.GetData("Select top 3 comment, Ratings.date, Benildeans.first_name, Benildeans.last_name " +
                ...
                "where Comments.is_deleted = '" + isDeleted + "' and Comments.is_review = 'y' " +
            ...
            public DataTable CommentRecommendationFilter()
            {
                ...
                "inner join Locations on Service_Providers_Locations.location_id = Locations.location_id " +
                "inner join Benildeans on Ratings.username = Benildeans.username " +
                "where Comments.is_deleted = '" + isDeleted + "' and Comments.is_review = 'n' " +
                "and Benildeans.type = '" + type + "' and Locations.location_id = '" + locationID + "' and Service_Providers.service_provider_id = '" + serviceProviderID + "' ORDER BY NEWID()");
            }
            ...
            public DataTable CommentRecommendationFilterAll()
            {
                ...
                "inner join Locations on Service_Providers_Locations.location_id = Locations.location_id " +
                "inner join Benildeans on Ratings.username = Benildeans.username " +
                "where Comments.is_deleted = '" + isDeleted + "' and Comments.is_review = 'n' ORDER BY NEWID()");
            }
            ...
            {
                return DAL.GetData("INSERT INTO Comments OUTPUT inserted.comment_id VALUES ('" + ratingID + "','" + comment + "','" + isReview + "','" + isDeleted + "')");
            }
            ...
            {
                return DAL.GetData("Select DISTINCT(Service_Providers.service_provider_id), Service_Providers.name from Service_Providers Where is_deleted = 'n'");
            ...
            {
                return DAL.GetData("Select DISTINCT(Service_Providers.name) as 'Service Provider' from Service_Providers Where is_deleted = 'n'");
            ...
            {
                return DAL.GetData("INSERT INTO Service_Providers OUTPUT inserted.service_provider_id VALUES ('" + name + "','n')");
            ...
            {
                return DAL.GetData("SELECT * FROM Service_Providers WHERE name = '" + name + "'");
            } //used in SPMO Manage - Service Provider Tab to check if already existing

            public DataTable ServiceProviderCheckIfDeleted()
            {
                return DAL.GetData("SELECT * FROM Service_Providers WHERE name = '" + name + "' and is_deleted = 'y'");
            ...
            public DataTable ServiceProviderSelectWithRatings()
            {
                return DAL.GetData("Select Distinct(Service_Providers.service_provider_id), Service_Providers.name from Service_Providers inner join Service_Providers_Locations " +
                    ...
                    "where Ratings.rating = 'happy' or Ratings.rating = 'sad' and Service_Providers.is_deleted = '" + isDeleted + "' and Service_Providers_Locations.is_deleted = '" + isDeleted + "' " +
                    "and Locations.is_deleted = '" + isDeleted + "' and Service_Providers_Locations.is_approved = '" + isApproved + "' " +
            ...
            public void ApproveDisapproveServiceProvider()
            {
            ...
            {
                return DAL.GetData("Select Service_Providers.name, Locations.name from Service_Providers_Locations, Service_Providers, Locations " +
                ...
                "and is_approved = 'y' and Service_Providers_Locations.is_deleted = 'n' order by Locations.name asc");
            ...
            public DataTable ServiceProviderLocationCheckIfServiceProviderExist2() 
            {
                ...
                "and Service_Providers_Locations.location_id = Locations.location_id " +
                "and Service_Providers_Locations.service_provider_id = '" + serviceProviderID + "' and Service_Providers_Locations.location_id = '" + locationID + "' and is_approved = 'y' and Service_Providers_Locations.is_deleted = 'n'");
            ...
            public DataTable ServiceProviderLocationCheckIfServiceProviderExist3() //used in SPMO Manage - Service Provider Location Tab to check if the service provider and Location exist in the tabLe
            {
                ...
                "where Service_Providers.service_provider_id = Service_Providers_Locations.service_provider_id " +
                "and Service_Providers_Locations.location_id = Locations.location_id " +
                "and Service_Providers_Locations.service_provider_id = '" + serviceProviderID + "' and Service_Providers_Locations.location_id = '" + locationID + "' and is_approved = 'y' and Service_Providers_Locations.is_deleted = 'y'");
            } // used in SPMO Manage - Service Provider Location
            ...
            {
                return DAL.GetData("SELECT * FROM Questions WHERE is_active = '" + isActive + "'");
            }
            public DataTable QuestionView()
            {
                return DAL.GetData("SELECT * FROM Questions WHERE is_deleted = '" + isDeleted + "'");
            }
            public void QuestionAdd()
            {
                DAL.Execute("INSERT INTO Questions VALUES ('" + question + "','" + isActive + "','" + isDeleted + "')");
            }
            ...
            {
                DAL.Execute("UPDATE Questions SET is_active = '" + isActive + "' WHERE question_id = '" + questionID + "'");
            }
            public void QuestionSetInactive()
            {
                DAL.Execute("UPDATE Questions SET is_active = '" + isActive + "' WHERE question_id NOT IN ('" + questionID + "')");
            }
            #endregion
            ...
            {
                return DAL.GetData("SELECT * FROM Rate_Limit WHERE is_active = '" + isActive + "'");
            }
            ...
            {
                return DAL.GetData("Select Service_Providers_Locations.Service_Provider_Location_ID, Suggestions.username, Locations.name as Location , Service_Providers.name as Service_Provider from Suggestions, Service_Providers, Service_Providers_Locations, Locations, Benildeans where Service_Providers_Locations.service_provider_location_id = Suggestions.service_provider_location_id and Service_Providers_Locations.service_provider_id = Service_Providers.service_provider_id and Locations.location_id = Service_Providers_Locations.location_id and Benildeans.username = Suggestions.username and Service_Providers_Locations.is_approved = '" + isApproved + "'");
            }
            #endregion
