...
<form id="SPMOForm" runat="server" >
    <!-- Header -->
      ...
      <div class="container">
		...
		<!-- Intro -->
			<section id="Home" class="main style1 dark fullscreen">
				<div class="content container 75%">
					...
					<footer>
						<a href="#comments" class="button style2 down">                    
                        </a>
					</footer>
				</div>
		...
		<!-- One -->
			<section id="comments" class="main style3 primary dark fullscreen">
				<div class="content container 75%">
                    <asp:UpdatePanel ID="upnlSearch" runat="server">
                        <ContentTemplate>
                            <h1 style="color:Black;">MANAGE COMMENTS</h1>
                            <asp:Label style="color:red; font-weight:bold" ID="lblCommentMessage" runat="server" Text=""></asp:Label>
                            <br />
                            <div id="dropDowns" style="margin-top:2%;">
                                <asp:DropDownList ID="ddlServiceProvidersInCommentTab" style="width:30%; display:inline" runat="server" class="form-control" AppendDataBoundItems="true">
                                    <asp:ListItem Text="All Service Providers" Selected="true" Value="All"></asp:ListItem>
                                </asp:DropDownList>
                                <asp:DropDownList ID="ddlLocationsInCommentTab" style="width:30%; display:inline" runat="server" class="form-control" AppendDataBoundItems="true">
                                    <asp:ListItem Text="All Locations" Selected="true" Value="All"></asp:ListItem>
                                </asp:DropDownList>
                                <asp:DropDownList ID="ddlRespondentsInCommentTab" style="width:30%; display:inline" runat="server" class="form-control" AppendDataBoundItems="true">
                                ...
                                <div id="gridview2" style="margin-top:5%; overflow-y:scroll; max-height:300px;">
		    ...
		    <section id="manageServiceProvider" class="main style3 dark fullscreen">
			    <div class="content container 75%">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
			                <center>
				                <h1 style="color:white; font-family:sans-serif; margin-bottom:5%;">MANAGE SERVICE PROVIDERS</h1>
                                <asp:Label ID="lblServiceProviderMessage" style="color:red; font-weight:bold" runat="server" Text=""></asp:Label>
                                <br />
				                <div id="div3">
            ...
            <section id="manageLocation" class="main style3 dark fullscreen">
			    <div class="content container 75%">
                    <asp:UpdatePanel ID="upnlLocation" runat="server">
                        <ContentTemplate>
			                <center>
				                <h1 style="color:black; font-family:sans-serif; margin-bottom:5%;">MANAGE LOCATIONS</h1>
				                <div id="div1Location">
                                    <b><asp:Label ID="lblLocationMessage" style="color:red;" runat="server" Text=""></asp:Label></b><br />
			    ...
			    <div class="content container 75%">
                    <asp:UpdatePanel ID="upnlServiceProviders" runat="server">
                        <ContentTemplate>   
                            ...
                            <asp:Label ID="lblServiceProviderLocationMessage" style="color:Red; font-weight:bold" runat="server" Text=""></asp:Label>
                            <br />
				            <div id="topForm">
                                <center>
                                ...
                                <asp:Button ID="btnServiceProviderLocationAdd" OnClick="btnServiceProviderLocationAdd_Click" runat="server" class="btn btn-success" 
                                         style="width:30%" Text="ADD SERVICE PROVIDER" />
<%--                                    <strong>
                                        <p id="aspP2">
                                            <asp:LinkButton ID="hlPendingServiceProvider" runat="server" 
                                                onclick="hlPendingServiceProvider_Click">VIEW PENDING SERVICE PROVIDER</asp:LinkButton>
                                    </strong>--%>
				            </div>
				            <br>
                            <br>
                            <div id="gridView" style="overflow-y:scroll; max-height:300px;">
			    ...
			    <div class="content container 75%">
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
					            ...
					            <p>
                                    <asp:Label ID="lblPending" style="color:red; font-weight:bold" runat="server"></asp:Label>
                                </p>
					            <div id="Div7">
                                ...
                                <asp:Button ID="btnApprovedSelected" OnClick="btnApprovedSelected_Click" runat="server" class="btn btn-success"  
                                        Text="Approve"></asp:Button>
					
                                <asp:Button ID="btnDisapprovedSelected" OnClick="btnDisapprovedSelected_Click" runat="server" class="btn btn-success"  
            ...
            <section id="changeRateLimit" class="main style3 dark fullscreen">
			    <div class="content container 75%">
                    <asp:UpdatePanel ID="upnlRateLimit" runat="server">
                        <ContentTemplate> 
			                <center>
                                <div>
				                    <h1 style="color:white; font-family:sans-serif; margin-bottom:5%;">MANAGE RATE LIMIT</h1> 
                                    <b><asp:Label ID="lblRateLimitError" style="color:red;" runat="server" Text=""></asp:Label></b>
                                    <asp:TextBox style="display:inline; width:50%; background-color:White; color:Black;" class="form-control" 
                                        placeholder="Rate Limit Hours" ID="txtAddRateLimit" runat="server" type="number" min="0" onpaste="return false"></asp:TextBox>
                                    <asp:Button ID="btnAddRateLimit" class="btn btn-success" 
                                        runat="server" Text="ADD RATE LIMIT" onclick="btnAddRateLimit_Click"></asp:Button>
				                    <br/>
				                </div>
				                <div id="div2RateLimit" style="margin-top:3%;">
                                    <asp:DropDownList style="display:inline; width:30%;" ID="ddlSelectRateLimit" 
                                        runat="server" class="form-control"></asp:DropDownList>
                                    <asp:Button class="btn btn-success" ID="btnSelectRateLimit" 
                                        runat="server" Text="SELECT RATE LIMIT" onclick="btnSelectRateLimit_Click"></asp:Button>
				                </div>
			                </center>
			    ...
			    <a href="#changeQuestion" class="button style1 down anchored">Next</a>
			</section>
			    ...
			    <div class="content container 75%">
                    <asp:UpdatePanel ID="upnlQuestion" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:Label ID="lblQuestionMessage" style="color:Red; font-weight:bold" runat="server" Text=""></asp:Label>
                            <br />
                        ...
                        <ContentTemplate>
			                <center>
				                ...
				                <div id="div1">
                                    ...
                                    <br />
                                    <asp:Label style="color:white; font-weight:bold; width:50%;" ID="lblCurrentAdmin" runat="server" Text=""></asp:Label>
					                <br/>
                                    <br />
				                </div>
       ...
       <br />
		...
		<!-- Footer -->
			<footer id="footer">
				...
				<!-- Menu -->
					<ul class="menu">
						<li>&copy; Team JARR</li><li>Design: <a href="http://html5up.net">HTML5 UP</a></li>
					</ul>
